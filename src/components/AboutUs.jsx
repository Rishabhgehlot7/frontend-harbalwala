      ...
      <div class="container mx-auto p-4 ">
        ...
        <div className='flex gap-1 justify-between md:flex-row flex-col items-center pt-5'>
          <div className=' max-w-[80%]'>
            <div className=' w-[100%] md:w-[500px] h-auto p-10 rounded-md shadow-lg md:absolute bg-white md:translate-x-[50%] md:translate-y-4 flex flex-col items-center '>
            ...
            <div className=' md:p-24 md:pt-56 p-3'>
          ...
          <div className=' md:w-80 w-[80%]  shadow-lg rounded-lg p-4'>
